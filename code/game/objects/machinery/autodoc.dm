...
/obj/machinery/autodoc
	...
	idle_power_usage = 15
	active_power_usage = 120 // It rebuilds you from nothing...

	var/stored_metal = 2000 // starts with 500 metal loaded
...
/obj/machinery/autodoc/proc/surgery_op()
	...
	while(surgery_todo_list.len > 0)
		...
		if(automaticmode)
			surgery_mod = 0.5 // automatic mode takes longer
		else
			surgery_mod = 0.2 // might need tweaking
