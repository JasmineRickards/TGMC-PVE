...
/obj/machinery/telecomms/receiver/preset_left
	...
	freq_listening = list(FREQ_MEDICAL, FREQ_REQUISITIONS, FREQ_ALPHA, FREQ_BRAVO, FREQ_CHARLIE, FREQ_DELTA, FREQ_COMMAND, FREQ_ENGINEERING, FREQ_CAS, FREQ_PMC, FREQ_COLONIST, FREQ_USL, FREQ_DEATHSQUAD, FREQ_IMPERIAL, FREQ_SOM, FREQ_SECTOID, FREQ_ALPHA_COLONY, FREQ_MEDICAL_COLONY, FREQ_COMMAND_COLONY, FREQ_ENGINEERING_COLONY, FREQ_ECHO)

/obj/machinery/telecomms/receiver/preset_left/rebel
	id = "Receiver A rebel"
	autolinkers = list("receiverA_rebel") // link to relay
	freq_listening = list(FREQ_MEDICAL_REBEL, FREQ_REQUISITIONS_REBEL, FREQ_ALPHA_REBEL, FREQ_BRAVO_REBEL, FREQ_CHARLIE_REBEL, FREQ_DELTA_REBEL, FREQ_COMMAND_REBEL, FREQ_ENGINEERING_REBEL, FREQ_CAS_REBEL, FREQ_PMC, FREQ_COLONIST, FREQ_USL, FREQ_DEATHSQUAD, FREQ_IMPERIAL, FREQ_SOM, FREQ_SECTOID, FREQ_ALPHA_COLONY, FREQ_MEDICAL_COLONY, FREQ_COMMAND_COLONY, FREQ_ENGINEERING_COLONY, FREQ_ECHO)
