...
//			/obj/item/weapon/gun/energy/lasgun/M43 = -1,
			...
			/obj/item/weapon/gun/energy/lasgun/lasrifle/lasercannon = 3,
		...
		"Marksman" = list(
			...
			/obj/item/ammo_magazine/minigun_powerpack/adaptive_ammopack/belt/sniper = -1,
		),
		"Shotgun" = list(
		...
		"Sidearm" = list(
			...
			/obj/item/ammo_magazine/minigun_powerpack/adaptive_ammopack/pouch = -1,
...
//			/obj/item/ammo_magazine/rifle/pepperball/pepperball_mini = -1,
			...
			/obj/item/attachable/foldable/t19stock = -1,
			/obj/item/attachable/foldable/t35stock = -1,
...
//			/obj/item/attachable/pulselens = -1,
		...
		"Boxes" = list(
			...
			/obj/item/ammo_magazine/packet/p50ae = -1,
...
//			/obj/item/weapon/gun/energy/lasgun/lasrifle = -1,
			...
			/obj/item/weapon/gun/energy/lasgun/lasrifle/lasercannon = -1,
...
/obj/machinery/vending/armor_supply
	...
	products = list(
		...
		"Helmets" = list(
			...
			/obj/item/clothing/head/helmet/marine/tech = -1,
			/obj/item/clothing/head/helmet/marine/corpsman = -1,
		),
...
/obj/machinery/vending/uniform_supply
	...
	products = list(
		...
		"Belts" = list(
			...
			/obj/item/storage/belt/gun/smg/standard_smg = -1,
			/obj/item/storage/belt/gun/smg/m25 = -1,
			/obj/item/storage/holster/blade/machete/full = -1,
			/obj/item/storage/holster/blade/machete/full_harvester = -1,
