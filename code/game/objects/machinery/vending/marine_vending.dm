...
//			/obj/item/weapon/gun/energy/lasgun/lasrifle = -1,
		...
		"Heavy Weapons" = list(
			...
			/obj/item/storage/holster/backholster/rpg/som/war_crimes = 2,
			/obj/item/ammo_magazine/rocket/som = 4,
			/obj/item/ammo_magazine/rocket/som/light = 4,
			/obj/item/ammo_magazine/rocket/som/rad = 16,
			/obj/item/ammo_magazine/rocket/som/incendiary = 16,
			/obj/item/ammo_magazine/rocket/som/heat = 16,
			/obj/item/ammo_magazine/rocket/som/thermobaric = 16,
		),
		"Attachments" = list(
...
//			/obj/item/weapon/gun/energy/lasgun/lasrifle = -1,
		...
		"Heavy Weapons" = list(
			...
			/obj/item/storage/holster/backholster/rpg/som/war_crimes = -1,
			/obj/item/ammo_magazine/rocket/som = -1,
			/obj/item/ammo_magazine/rocket/som/light = -1,
			...
			/obj/item/ammo_magazine/rocket/som/thermobaric = -1,
		),
		"Attachments" = list(
			/obj/item/attachable/bayonet = -1,
			/obj/item/attachable/compensator = -1,
...
/obj/machinery/vending/valhalla_req
	...
	products = list(
		"Weapon" = list(
			...
			/obj/item/ammo_magazine/rifle/standard_dmr/incendiary = -1,
			/obj/item/ammo_magazine/rifle/standard_br/incendiary = -1,
			...
			/obj/item/storage/box/visual/grenade/phosphorus = -1,
			...
			/obj/item/ammo_magazine/rifle/box/ap = -1,
			/obj/item/weapon/gun/smg/m25/elite = -1,
			/obj/item/ammo_magazine/smg/m25/extended = -1,
			/obj/item/ammo_magazine/smg/m25/ap = -1,
			/obj/item/ammo_magazine/packet/packet/ap = -1,
			/obj/item/ammo_magazine/smg/som/ap = -1,
			/obj/item/ammo_magazine/smg/som/incendiary = -1,
			/obj/item/ammo_magazine/smg/som/extended = -1,
			/obj/item/ammo_magazine/rifle/som/ap = -1,
			/obj/item/ammo_magazine/rifle/som/incendiary = -1,
		...
		"Equipment" = list(
			...
			/obj/item/storage/backpack/dispenser = -1,
			...
			/obj/item/loot_box/tgmclootbox = -1,
