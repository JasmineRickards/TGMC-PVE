...
/obj/item/radio/headset/mainship/survivor/minimap/director
	name = "director's headset"
	desc = "A colony director's headset, with a working minimap and access to TerraGov Communications!"
