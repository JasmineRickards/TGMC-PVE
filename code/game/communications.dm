...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_COMMAND_COLONY = FREQ_COMMAND_COLONY,
	RADIO_CHANNEL_ENGINEERING_COLONY = FREQ_ENGINEERING_COLONY,
	RADIO_CHANNEL_MEDICAL_COLONY = FREQ_MEDICAL_COLONY,
	RADIO_CHANNEL_ALPHA_COLONY = FREQ_ALPHA_COLONY,
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_COMMAND_COLONY]" = RADIO_CHANNEL_COMMAND_COLONY,
	"[FREQ_ENGINEERING_COLONY]" = RADIO_CHANNEL_ENGINEERING_COLONY,
	"[FREQ_MEDICAL_COLONY]" = RADIO_CHANNEL_MEDICAL_COLONY,
	"[FREQ_ALPHA_COLONY]" = RADIO_CHANNEL_ALPHA_COLONY,
