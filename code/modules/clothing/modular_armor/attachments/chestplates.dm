...
/obj/item/armor_module/armor/chest/marine
	...
	icon_state = "infantry_chest"
	soft_armor = list(MELEE = 25, BULLET = 60, LASER = 45, ENERGY = 35, BOMB = 30, BIO = 30, FIRE = 30, ACID = 35)
	slowdown = 0.3
	greyscale_config = /datum/greyscale_config/modularchest
...
/obj/item/armor_module/armor/chest/marine/skirmisher
	...
	soft_armor = list(MELEE = 20, BULLET = 60, LASER = 40, ENERGY = 30, BOMB = 30, BIO = 30, FIRE = 30, ACID = 30)
	slowdown = 0.1
...
/obj/item/armor_module/armor/chest/marine/assault
	...
	soft_armor = list(MELEE = 30, BULLET = 60, LASER = 50, ENERGY = 40, BOMB = 30, BIO = 30, FIRE = 30, ACID = 40)
	slowdown = 0.5
