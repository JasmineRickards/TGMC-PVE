...
/obj/item/armor_module/module/better_shoulder_lamp
	...
	slowdown = 0
	light_mod = 7 /// The boost to armor shoulder light
...
/obj/item/armor_module/module/tyr_head
	...
	variants_by_parent_type = list(/obj/item/clothing/head/modular/marine/m10x = "tyr_head_xn", /obj/item/clothing/head/modular/marine/m10x/leader = "tyr_head_xn", /obj/item/clothing/head/helmet/marine/ = "tyr_head_ua")
...
/obj/item/armor_module/module/chemsystem/mk2
	name = "\improper Vali mk.2 Chemical Enhancement Module"
	...
	soft_armor = list(MELEE = 20, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, FIRE = 0, ACID = 20)
	icon_state = "mod_chemsystem"
	item_state = "mod_chemsystem_a"
	slowdown = 0.1
...
/obj/item/armor_module/module/eshield/mkex
	name = "Arrowhead mk.ex Energy Shield System"
	desc = "A brand new innovation in armor systems, this module creates a shield around the user that is capable of negating all damage. If it sustains too much it will deactivate, and leave the user vulnerable. This model uses special nanite protection, making it even more powerful."
	icon = 'icons/mob/modular/modular_armor_modules.dmi'
	icon_state = "mod_eshield"
	item_state = "mod_eshield_a"
	slot = ATTACHMENT_SLOT_MODULE
	...
	shield_color_low = COLOR_MAROON
	///Shield color when the shield is 33 - 66% full
	shield_color_mid = COLOR_STRONG_VIOLET
	///Shield color when the shield is 66% to full
	shield_color_full = COLOR_VIOLET
	///Current shield color
	current_color
	///Delay it takes to start recharging again after the shield has been damaged.
...
/obj/item/armor_module/module/welding
	...
	slot = ATTACHMENT_SLOT_HEAD_MODULE
	variants_by_parent_type = list(/obj/item/clothing/head/modular/marine/m10x = "welding_head_xn", /obj/item/clothing/head/modular/marine/m10x/leader = "welding_head_xn", /obj/item/clothing/head/modular/som/welder = "welding_head_som", /obj/item/clothing/head/helmet/marine/tech = "welding_head_m10")
