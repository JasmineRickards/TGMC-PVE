...
=======
	soft_armor = list(MELEE = 40, BULLET = 80, LASER = 60, ENERGY = 45, BOMB = 45, BIO = 45, FIRE = 45, ACID = 50)
>>>>>>> Stashed changes
...
/obj/item/clothing/suit/storage/marine/M3HB
	...
	icon_state = "1"
	soft_armor = list(MELEE = 65, BULLET = 80, LASER = 70, ENERGY = 30, BOMB = 60, BIO = 50, FIRE = 50, ACID = 55)
...
/obj/item/clothing/suit/storage/marine/M3LB
	...
	icon_state = "2"
	soft_armor = list(MELEE = 45, BULLET = 80, LASER = 55, ENERGY = 20, BOMB = 45, BIO = 30, FIRE = 25, ACID = 35)
...
/obj/item/clothing/suit/storage/marine/M3IS
	...
	icon_state = "4"
	soft_armor = list(MELEE = 60, BULLET = 80, LASER = 65, ENERGY = 20, BOMB = 50, BIO = 35, FIRE = 35, ACID = 50)
	slowdown = SLOWDOWN_ARMOR_HEAVY
...
/obj/item/clothing/suit/storage/marine/M3E
	...
	desc = "A standard Marine M3 Edge Pattern Chestplate. High protection against cuts and slashes, but very little padding against lasers, flames, or explosions."
	icon_state = "5"
	soft_armor = list(MELEE = 70, BULLET = 80, LASER = 15, ENERGY = 20, BOMB = 15, BIO = 10, FIRE = 10, ACID = 10)
...
/obj/item/clothing/suit/storage/marine/M3P/tech
	...
	icon_state = "tanker"
	soft_armor = list(MELEE = 40, BULLET = 80, LASER = 60, ENERGY = 45, BOMB = 60, BIO = 45, FIRE = 45, ACID = 65)
...
/obj/item/clothing/suit/storage/marine/leader
	...
	icon_state = "7"
	soft_armor = list(MELEE = 40, BULLET = 80, LASER = 55, ENERGY = 40, BOMB = 40, BIO = 40, FIRE = 40, ACID = 45)
...
/obj/item/clothing/suit/storage/marine/smartgunner
	...
	flags_cold_protection = CHEST|GROIN|ARMS|LEGS|HANDS|FEET
	flags_heat_protection = CHEST|GROIN|ARMS|LEGS|HANDS|FEET
	soft_armor = list(MELEE = 45, BULLET = 80, LASER = 65, ENERGY = 35, BOMB = 35, BIO = 30, FIRE = 35, ACID = 45)
	slowdown = SLOWDOWN_ARMOR_LIGHT
	allowed = list(
		/obj/item/tank/emergency_oxygen,
		/obj/item/flashlight,
...
/obj/item/clothing/suit/storage/marine/M3T
	...
	soft_armor = list(MELEE = 60, BULLET = 80, LASER = 45, ENERGY = 30, BOMB = 55, BIO = 35, FIRE = 30, ACID = 30)
	slowdown = SLOWDOWN_ARMOR_LIGHT
...
/obj/item/clothing/suit/storage/marine/M3S
	...
	soft_armor = list(MELEE = 60, BULLET = 80, LASER = 70, ENERGY = 30, BOMB = 40, BIO = 35, FIRE = 30, ACID = 35)
	slowdown = SLOWDOWN_ARMOR_LIGHT
...
/obj/item/clothing/suit/storage/marine/M35
	...
	soft_armor = list(MELEE = 65, BULLET = 80, LASER = 65, ENERGY = 65, BOMB = 35, BIO = 35, FIRE = 95, ACID = 50)
...
/obj/item/clothing/suit/storage/marine/sniper
	...
	soft_armor = list(MELEE = 60, BULLET = 80, LASER = 65, ENERGY = 30, BOMB = 35, BIO = 35, FIRE = 30, ACID = 30)
	slowdown = SLOWDOWN_ARMOR_LIGHT
...
/obj/item/clothing/suit/storage/marine/veteran/PMC
	...
	soft_armor = list(MELEE = 55, BULLET = 80, LASER = 60, ENERGY = 38, BOMB = 50, BIO = 15, FIRE = 38, ACID = 45)
	slowdown = SLOWDOWN_ARMOR_LIGHT
	allowed = list(
		/obj/item/weapon/gun,
		/obj/item/tank/emergency_oxygen,
...
/obj/item/clothing/suit/storage/marine/veteran/PMC/leader
	...
	soft_armor = list(MELEE = 60, BULLET = 80, LASER = 65, ENERGY = 65, BOMB = 60, BIO = 50, FIRE = 50, ACID = 45)


/obj/item/clothing/suit/storage/marine/veteran/PMC/sniper
	name = "\improper M4 pattern PMC sniper armor"
	icon_state = "pmc_sniper"
	soft_armor = list(MELEE = 55, BULLET = 80, LASER = 55, ENERGY = 60, BOMB = 75, BIO = 10, FIRE = 60, ACID = 60)
...
/obj/item/clothing/suit/storage/marine/veteran/wolves
	...
	flags_cold_protection = CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	flags_heat_protection =CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	soft_armor = list(MELEE = 70, BULLET = 80, LASER = 50, ENERGY = 60, BOMB = 50, BIO = 10, FIRE = 60, ACID = 60)
	slowdown = SLOWDOWN_ARMOR_VERY_LIGHT
...
/obj/item/clothing/suit/storage/marine/veteran/dutch
	...
	flags_cold_protection = CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	flags_heat_protection =CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	soft_armor = list(MELEE = 55, BULLET = 80, LASER = 55, ENERGY = 65, BOMB = 70, BIO = 10, FIRE = 65, ACID = 30)
	slowdown = SLOWDOWN_ARMOR_VERY_LIGHT
...
/obj/item/clothing/suit/storage/marine/imperial
	...
	soft_armor = list(MELEE = 75, BULLET = 80, LASER = 60, ENERGY = 60, BOMB = 50, BIO = 0, FIRE = 60, ACID = 60)
	flags_item_map_variant = NONE
...
/obj/item/clothing/suit/storage/marine/imperial/power
	...
	//icon_state
	soft_armor = list(MELEE = 75, BULLET = 80, LASER = 55, ENERGY = 40, BOMB = 45, BIO = 15, FIRE = 40, ACID = 40)
	light_range = 9
	pockets = /obj/item/storage/internal/suit/imperial
...
/obj/item/clothing/suit/storage/faction
	...
	max_heat_protection_temperature = ARMOR_MAX_HEAT_PROTECTION_TEMPERATURE
	blood_overlay_type = "armor"
	soft_armor = list(MELEE = 50, BULLET = 80, LASER = 35, ENERGY = 20, BOMB = 25, BIO = 10, FIRE = 20, ACID = 20)
	siemens_coefficient = 0.7
	slowdown = SLOWDOWN_ARMOR_MEDIUM
	allowed = list(
		/obj/item/weapon/gun,
...
/obj/item/clothing/suit/storage/faction/UPP
	...
	slowdown = SLOWDOWN_ARMOR_MEDIUM
	flags_armor_protection = CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	soft_armor = list(MELEE = 55, BULLET = 80, LASER = 60, ENERGY = 60, BOMB = 55, BIO = 10, FIRE = 60, ACID = 60)
...
/obj/item/clothing/suit/storage/faction/UPP/hvh
	soft_armor = list(MELEE = 55, BULLET = 80, LASER = 75, ENERGY = 60, BOMB = 60, BIO = 45, FIRE = 60, ACID = 65)
...
/obj/item/clothing/suit/storage/faction/UPP/heavy
	...
	slowdown = SLOWDOWN_ARMOR_HEAVY
	soft_armor = list(MELEE = 65, BULLET = 80, LASER = 65, ENERGY = 60, BOMB = 60, BIO = 10, FIRE = 60, ACID = 60)
...
/obj/item/clothing/suit/storage/faction/freelancer
	...
	flags_cold_protection = CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	flags_heat_protection =CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	soft_armor = list(MELEE = 50, BULLET = 80, LASER = 50, ENERGY = 60, BOMB = 40, BIO = 10, FIRE = 60, ACID = 50)
...
/obj/item/clothing/suit/storage/faction/militia
	...
	flags_heat_protection =CHEST|GROIN|ARMS|LEGS|FEET|HANDS
	flags_item = SYNTH_RESTRICTED
	soft_armor = list(MELEE = 40, BULLET = 80, LASER = 40, ENERGY = 30, BOMB = 60, BIO = 30, FIRE = 30, ACID = 30)
	allowed = list(
		/obj/item/weapon/twohanded,
		/obj/item/weapon/gun,
		/obj/item/tank/emergency_oxygen,
...
/obj/item/clothing/suit/storage/marine/veteran/mercenary
	...
	soft_armor = list(MELEE = 75, BULLET = 80, LASER = 42, ENERGY = 38, BOMB = 40, BIO = 15, FIRE = 38, ACID = 38)
	slowdown = SLOWDOWN_ARMOR_LIGHT
	allowed = list(
		/obj/item/weapon/gun,
		/obj/item/tank/emergency_oxygen,
...
/obj/item/clothing/suit/storage/marine/veteran/mercenary/miner
	...
	soft_armor = list(MELEE = 50, BULLET = 80, LASER = 42, ENERGY = 38, BOMB = 25, BIO = 15, FIRE = 38, ACID = 38)
	slowdown = SLOWDOWN_ARMOR_LIGHT
	allowed = list(
		/obj/item/weapon/gun,
		/obj/item/tank/emergency_oxygen,
...
/obj/item/clothing/suit/storage/marine/veteran/mercenary/engineer
	...
	soft_armor = list(MELEE = 55, BULLET = 80, LASER = 42, ENERGY = 38, BOMB = 30, BIO = 15, FIRE = 38, ACID = 38)
	slowdown = SLOWDOWN_ARMOR_LIGHT
	allowed = list(
		/obj/item/weapon/gun,
		/obj/item/tank/emergency_oxygen,
...
/obj/item/clothing/suit/storage/marine/som
	...
	slowdown = SLOWDOWN_ARMOR_LIGHT
	flags_armor_protection = CHEST|GROIN|ARMS|LEGS|HANDS|FEET
	soft_armor = list(MELEE = 50, BULLET = 80, LASER = 55, ENERGY = 55, BOMB = 55, BIO = 55, FIRE = 55, ACID = 55)
	flags_item_map_variant = NONE
...
/obj/item/clothing/suit/storage/marine/som/veteran
	...
	slowdown = SLOWDOWN_ARMOR_HEAVY
	flags_armor_protection = CHEST|GROIN|ARMS|LEGS|HANDS|FEET
	soft_armor = list(MELEE = 65, BULLET = 80, LASER = 70, ENERGY = 55, BOMB = 55, BIO = 55, FIRE = 55, ACID = 60)
...
/obj/item/clothing/suit/storage/marine/som/leader
	...
	slowdown = SLOWDOWN_ARMOR_MEDIUM
	flags_armor_protection = CHEST|GROIN|ARMS|LEGS|HANDS|FEET
	soft_armor = list(MELEE = 55, BULLET = 80, LASER = 40, ENERGY = 55, BOMB = 55, BIO = 55, FIRE = 55, ACID = 60)
...
/obj/item/clothing/suit/storage/marine/robot
	...
	flags_item_map_variant = (ITEM_JUNGLE_VARIANT|ITEM_ICE_VARIANT|ITEM_PRISON_VARIANT)
	soft_armor = list(MELEE = 45, BULLET = 80, LASER = 65, ENERGY = 55, BOMB = 50, BIO = 50, FIRE = 50, ACID = 55)
	slowdown = 0.5
...
/obj/item/clothing/suit/storage/marine/robot/light
	...
	soft_armor = list(MELEE = 40, BULLET = 80, LASER = 60, ENERGY = 55, BOMB = 50, BIO = 50, FIRE = 50, ACID = 50)
	slowdown = 0.3
...
/obj/item/clothing/suit/storage/marine/robot/heavy
	...
	soft_armor = list(MELEE = 50, BULLET = 80, LASER = 70, ENERGY = 55, BOMB = 50, BIO = 50, FIRE = 50, ACID = 60)
	slowdown = 0.7
