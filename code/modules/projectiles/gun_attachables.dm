...
/obj/item/attachable/foldable/bipod/proc/retract_bipod(datum/source, mob/living/user)
	...
	playsound(source, 'sound/machines/click.ogg', 15, 1, 4) //CLICK CLICK CLICK
...
/obj/item/attachable/shoulder_mount/on_attach(attaching_item, mob/user)
	...
	attaching_gun.AddElement(/datum/element/attachment, ATTACHMENT_SLOT_SHOULDER, icon, null, null, null, null, 0, 0, flags_attach_features, attach_delay, detach_delay, attach_skill, attach_skill_upper_threshold, attach_sound, attachment_layer = COLLAR_LAYER)
...
/obj/item/attachable/shoulder_mount/on_detach(detaching_item, mob/user)
	var/obj/item/weapon/gun/detaching_gun = detaching_item
	detaching_gun.RemoveElement(/datum/element/attachment, ATTACHMENT_SLOT_SHOULDER, icon, null, null, null, null, 0, 0, flags_attach_features, attach_delay, detach_delay, attach_skill, attach_skill_upper_threshold, attach_sound, attachment_layer = COLLAR_LAYER)
