/datum/xeno_caste/drone
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 0, BULLET = 10, LASER = 10, ENERGY = 10, BOMB = 0, BIO = 0, FIRE = -10, ACID = 0)
...
/datum/xeno_caste/drone/mature
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 5, BULLET = 17, LASER = 17, ENERGY = 17, BOMB = 0, BIO = 5, FIRE = -17, ACID = 5)
...
/datum/xeno_caste/drone/elder
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 5, BULLET = 24, LASER = 24, ENERGY = 24, BOMB = 0, BIO = 10, FIRE = -24, ACID = 10)
...
/datum/xeno_caste/drone/ancient
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 10, BULLET = 31, LASER = 31, ENERGY = 31, BOMB = 0, BIO = 15, FIRE = -31, ACID = 15)
...
/datum/xeno_caste/drone/primordial
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 15, BULLET = 31, LASER = 31, ENERGY = 31, BOMB = 0, BIO = 15, FIRE = -31, ACID = 15)
