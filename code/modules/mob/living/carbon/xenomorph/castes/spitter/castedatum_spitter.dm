/datum/xeno_caste/spitter
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -200, BULLET = 20, LASER = 20, ENERGY = 20, BOMB = 0, BIO = 10, FIRE = -20, ACID = 10)
...
/datum/xeno_caste/spitter/mature
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -100, BULLET = 25, LASER = 25, ENERGY = 25, BOMB = 0, BIO = 15, FIRE = -25, ACID = 15)
...
/datum/xeno_caste/spitter/elder
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -100, BULLET = 30, LASER = 30, ENERGY = 30, BOMB = 0, BIO = 18, FIRE = -30, ACID = 18)
...
/datum/xeno_caste/spitter/ancient
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -100, BULLET = 35, LASER = 35, ENERGY = 35, BOMB = 0, BIO = 20, FIRE = -35, ACID = 20)
