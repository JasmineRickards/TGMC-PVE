/datum/xeno_caste/queen
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 5, BULLET = 50, LASER = 50, ENERGY = 50, BOMB = 30, BIO = 45, FIRE = 45, ACID = 45)
...
/datum/xeno_caste/queen/mature
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 10, BULLET = 55, LASER = 55, ENERGY = 55, BOMB = 30, BIO = 50, FIRE = 50, ACID = 50)
...
/datum/xeno_caste/queen/elder
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 15, BULLET = 60, LASER = 60, ENERGY = 60, BOMB = 30, BIO = 55, FIRE = 55, ACID = 55)
...
/datum/xeno_caste/queen/ancient
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 20, BULLET = 65, LASER = 65, ENERGY = 65, BOMB = 30, BIO = 60, FIRE = 60, ACID = 60)
...
/datum/xeno_caste/queen/primordial
	...
	// *** Defense *** //
	soft_armor = list(MELEE = 25, BULLET = 65, LASER = 65, ENERGY = 65, BOMB = 30, BIO = 60, FIRE = 60, ACID = 60)
