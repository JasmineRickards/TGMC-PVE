/datum/xeno_caste/ravager
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -100, BULLET = 40, LASER = 30, ENERGY = 30, BOMB = 10, BIO = 30, FIRE = 50, ACID = 30)
...
/datum/xeno_caste/ravager/mature
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -90, BULLET = 45, LASER = 40, ENERGY = 40, BOMB = 10, BIO = 35, FIRE = 55, ACID = 35)
...
/datum/xeno_caste/ravager/elder
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -80, BULLET = 50, LASER = 45, ENERGY = 45, BOMB = 10, BIO = 38, FIRE = 65, ACID = 38)
...
/datum/xeno_caste/ravager/ancient
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -80, BULLET = 55, LASER = 50, ENERGY = 50, BOMB = 10, BIO = 40, FIRE = 70, ACID = 40)
...
/datum/xeno_caste/ravager/primordial
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -60, BULLET = 55, LASER = 50, ENERGY = 50, BOMB = 10, BIO = 40, FIRE = 70, ACID = 40)
