/datum/xeno_caste/crusher
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -100, BULLET = 60, LASER = 60, ENERGY = 60, BOMB = 100, BIO = 80, FIRE = -25, ACID = 80)
...
/datum/xeno_caste/crusher/mature
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -90, BULLET = 65, LASER = 65, ENERGY = 65, BOMB = 100, BIO = 90, FIRE = -30, ACID = 90)
...
/datum/xeno_caste/crusher/elder
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -90, BULLET = 70, LASER = 70, ENERGY = 70, BOMB = 100, BIO = 95, FIRE = -35, ACID = 95)
...
/datum/xeno_caste/crusher/ancient
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -80, BULLET = 75, LASER = 75, ENERGY = 75, BOMB = 100, BIO = 100, FIRE = -40, ACID = 100)
	// *** Abilities *** //
	stomp_damage = 60
...
/datum/xeno_caste/crusher/primordial
	...
	// *** Defense *** //
	soft_armor = list(MELEE = -50, BULLET = 75, LASER = 75, ENERGY = 75, BOMB = 100, BIO = 100, FIRE = -40, ACID = 100)
	// *** Abilities *** //
	stomp_damage = 60
	crest_toss_distance = 6
