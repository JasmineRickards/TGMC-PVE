#define UPLOAD_LIMIT 10000000	//Restricts client uploads to the server to 1MB
#define UPLOAD_LIMIT_ADMIN 1000000000	//Restricts admin uploads to the server to 10MB
