SUBSYSTEM_DEF(research)
	...
	/obj/item/research_resource/xeno/tier_one		= list(TECHWEB_POINT_TYPE_GENERIC = 500),
	/obj/item/research_resource/xeno/tier_two    	= list(TECHWEB_POINT_TYPE_GENERIC = 1500),
	/obj/item/research_resource/xeno/tier_three		= list(TECHWEB_POINT_TYPE_GENERIC = 3000),
	/obj/item/research_resource/xeno/tier_four		= list(TECHWEB_POINT_TYPE_GENERIC = 10000),
	)
