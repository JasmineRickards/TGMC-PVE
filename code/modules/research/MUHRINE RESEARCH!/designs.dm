...
/obj/item/disk/design_disk
	...
	custom_materials = list(/datum/material/metal=300, /datum/material/glass=100)
...
/obj/item/disk/design_disk/adv
	...
	custom_materials = list(/datum/material/metal=300, /datum/material/glass=100, /datum/material/silver = 50)
	max_blueprints = 5
