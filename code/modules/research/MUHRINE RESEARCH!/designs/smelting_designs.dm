...
/datum/design/plasteel_alloy
	...
	materials = list(/datum/material/metal = MINERAL_MATERIAL_AMOUNT, /datum/material/plasma = MINERAL_MATERIAL_AMOUNT)
...
/datum/design/plasmarglass_alloy
	...
	build_type = SMELTER | PROTOLATHE
	materials = list(/datum/material/plasma = MINERAL_MATERIAL_AMOUNT * 0.5, /datum/material/metal = MINERAL_MATERIAL_AMOUNT * 0.5,  /datum/material/glass = MINERAL_MATERIAL_AMOUNT)
...
/datum/design/alienalloy
	...
	materials = list(/datum/material/metal = 4000, /datum/material/plasma = 4000)
