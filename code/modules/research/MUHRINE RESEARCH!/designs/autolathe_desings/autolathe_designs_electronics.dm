...
/datum/design/desttagger
	...
	id = "desttagger"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(/datum/material/metal = 250, /datum/material/glass = 125)
...
/datum/design/handlabeler
	...
	id = "handlabel"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(/datum/material/metal = 150, /datum/material/glass = 125)
...
/datum/design/electrochromatic_kit
	...
	build_type = AUTOLATHE
	materials = list(/datum/material/metal = 2010, /datum/material/glass = 5)
