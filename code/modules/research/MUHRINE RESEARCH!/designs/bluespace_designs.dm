...
/datum/design/telesci_gps
	...
	id = "telesci_gps"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 500, /datum/material/glass = 1000)
...
/datum/design/desynchronizer
	...
	id = "desynchronizer"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 1000, /datum/material/glass = 500, /datum/material/silver = 1500, /datum/material/bluespace = 1000)
...
/datum/design/bluespace_tray
	...
	materials = list(/datum/material/metal = 2000, /datum/material/bluespace = 500)
	category = list("Bluespace Designs")
