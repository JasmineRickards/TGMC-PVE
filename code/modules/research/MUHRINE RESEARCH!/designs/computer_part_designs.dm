...
/datum/design/disk/normal
	...
	materials = list(/datum/material/metal = 400, /datum/material/glass = 100)
...
/datum/design/disk/super
	...
	id = "hdd_super"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 1600, /datum/material/glass = 400)
...
/datum/design/disk/cluster
	...
	id = "hdd_cluster"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 3200, /datum/material/glass = 800)
...
/datum/design/netcard/basic
	...
	materials = list(/datum/material/metal = 250, /datum/material/glass = 100)
...
/datum/design/netcard/advanced
	...
	id = "netcard_advanced"
	build_type = IMPRINTER
	materials = list(/datum/material/metal = 500, /datum/material/glass = 200)
...
/datum/design/netcard/wired
	...
	id = "netcard_wired"
	build_type = IMPRINTER
	materials = list(/datum/material/metal = 2500, /datum/material/glass = 400)
...
/datum/design/cardslot
	...
	id = "cardslot"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 600)
...
/datum/design/battery/controller
	...
	id = "bat_control"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 400)
...
/datum/design/battery/advanced
	...
	id = "bat_advanced"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 800)
...
/datum/design/battery/super
	...
	id = "bat_super"
	build_type = PROTOLATHE
	materials = list(/datum/material/metal = 1600)
