...
/datum/chemical_reaction/russian_red
	...
	required_reagents = list(/datum/reagent/bicaridine = 1, /datum/reagent/medicine/meralyne = 1, /datum/chemical_reaction/kelotane = 1, /datum/reagent/medicine/dermaline = 1, /datum/reagent/medicine/inaprovaline = 1, /datum/reagent/medicine/oxycodone = 1,)
