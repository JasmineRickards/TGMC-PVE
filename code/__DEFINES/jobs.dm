...
#define JOB_DISPLAY_ORDER_DIRECTOR 26
#define JOB_DISPLAY_ORDER_CMB 27
#define JOB_DISPLAY_ORDER_FIGHTER_SEC 28
#define JOB_DISPLAY_ORDER_FIGHTER 29
#define JOB_DISPLAY_ORDER_SUPPORT 30
#define JOB_DISPLAY_ORDER_MISC 31
...
CHIEF_MEDICAL_OFFICER, SYNTHETIC, SILICON_AI, COMMAND_MASTER_AT_ARMS, MASTER_AT_ARMS, CORPORATE_LIAISON, SHIP_TECH, \
